    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card  shadow border-0">
                <div class="card-header bg-warning">Edit your Pub</div>
                ...
                <div class="card-body p-3">
                    <form method="POST" action="{{ route('image.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                            <img src="{{route('share.avatar',['image_path'=>$image->image_path])}}" width="40"   alt="">

                                <input id="image" type="file" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" accept="image/*"   autofocus>
